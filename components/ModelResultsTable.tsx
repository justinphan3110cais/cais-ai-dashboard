...
export const DashboardTable = ({ 
  ...
  const tableContent = (
        <Table
          className={compact ? "w-full table-auto" : "min-w-[800px]"}
          style={{ touchAction: 'pan-x pan-y' }}
        >
      <TableHeader className="sticky top-0 bg-background z-40">
            <TableRow>
          <TableHead 
            className={`${compact ? 'w-0 whitespace-nowrap' : 'w-[200px]'} border-r border-gray-300 border-b-2 border-b-gray-300 sticky left-0 ${bgColor}`}
