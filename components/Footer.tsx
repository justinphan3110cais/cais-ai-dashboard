        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 mb-12">
          ...
          <div className="flex-shrink-0">
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
              ...
              >
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">Keep up to date with AI updates</h2>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>General: dashboard@safe.ai</span>
              </Link>
