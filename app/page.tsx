...
export default function LandingPage() {
  ...
  const getCurrentVisibleSection = () => {
    const sections = ['text', 'vision', 'safety', 'automation'];
    const navHeight = 64;
  ...
  React.useEffect(() => {
    const handleHashNavigation = () => {
      ...
      // Support both 'risk' and 'safety' URLs for the safety section
      if (hash === 'risk') {
        hash = 'safety';
      }
      if (hash && (hash === 'text' || hash === 'vision' || hash === 'safety' || hash === 'automation')) {
        ...
        <div className="relative h-64 flex items-center justify-center">
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 text-center w-full px-4">
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <h1 
                className="text-4xl tracking-tight lg:text-5xl text-gray-900"
                style={{ 
          ...
          <div className="mx-auto mb-6 h-0.5 w-16 bg-gradient-to-r from-gray-300 to-gray-100"></div>
            ...
            <div className="relative">
              <div className="rounded-lg bg-gray-50 p-4">
                <pre className="max-h-[200px] overflow-x-auto overflow-y-scroll whitespace-pre text-[10px] sm:text-xs scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  {BIBTEX_CITATION}
                </pre>
              <button
                onClick={() => {
