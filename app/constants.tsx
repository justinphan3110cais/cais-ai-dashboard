...
export const SAFETY_DATASETS: Dataset[] = [
  ...
  },
  {
    ...
    description: "<a href='https://www.virologytest.ai' target='_blank' style='font-weight: 500; text-decoration: underline; text-decoration-style: dashed; text-underline-offset: 4px;'>Virology Capabilities Test (VCT)</a> Refusal measures the rate at which AIs refuse hazardous expert-level virology queries. VCT-Refusal is a subset of VCT that is manually labeled by experts for queries that should be refused because of potential <b><i>dual-use</i></b>. <br>The ability to provide expert-level troubleshooting is inherently <b><i>dual-use</i></b>: it is useful for beneficial research, but it can also be misused in particularly harmful ways.",
    category: "safety",
    logo: vct_logo,
